...
return [
    ...
    */
    ...
    |
    */
    'prefix' => env('DATADOG_METRICS_PREFIX', 'decapi'), // metrics prefix

    'api_key' => env('DATADOG_API_KEY', null),

    'application_key' => env('DATADOG_APP_KEY', null),

    'datadog_host' => 'https://app.datadoghq.com',

    'statsd_server' => env('DATADOG_STATSD_SERVER', 'localhost'),
