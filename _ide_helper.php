...
namespace Alaouy\Youtube\Facades {
    ...
    class Youtube {
         ...
         * @static
         */
        public static function useHttpHost($setting)
        {
            /** @var \Alaouy\Youtube\Youtube $instance */
            return $instance->useHttpHost($setting);
        }
         ...
         * @static
         */
        public static function getLocalizedVideoInfo($vId, $language, $part = [])
        {
            /** @var \Alaouy\Youtube\Youtube $instance */
            return $instance->getLocalizedVideoInfo($vId, $language, $part);
        }
         ...
         * @static
         */
        public static function getPopularVideos($regionCode, $maxResults = 10, $part = [], $videoCategoryId = 0)
        {
            /** @var \Alaouy\Youtube\Youtube $instance */
            return $instance->getPopularVideos($regionCode, $maxResults, $part, $videoCategoryId);
        }
         ...
         * @static
         */
        public static function getChannelByName($username, $optionalParams = [], $part = [])
        {
            /** @var \Alaouy\Youtube\Youtube $instance */
         ...
         * @static
         */
        public static function getChannelByHandle($handleName, $optionalParams = [], $part = [])
        {
            /** @var \Alaouy\Youtube\Youtube $instance */
            return $instance->getChannelByHandle($handleName, $optionalParams, $part);
        }
         ...
         * @static
         */
        public static function searchChannelByName($username, $maxResults = 1, $part = [])
        {
            /** @var \Alaouy\Youtube\Youtube $instance */
            return $instance->searchChannelByName($username, $maxResults, $part);
        }
         ...
         * @static
         */
        public static function getChannelById($id, $optionalParams = [], $part = [])
        {
            /** @var \Alaouy\Youtube\Youtube $instance */
